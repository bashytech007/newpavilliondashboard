...
import { Activity, Scale, FileText, Search } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
export function DashboardContent({ activeCases, researchCount = 20 }: { activeCases?: number, researchCount?: number }) {
  return (
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              An overview of legal research queries over the year.
            </CardDescription>
          </CardHeader>
